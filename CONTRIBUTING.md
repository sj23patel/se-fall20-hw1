# Contributing to SE-HW1

:+1::tada: First off, thanks for taking the time to contribute! :tada::+1:

The following is a set of guidelines for contributing to CSC 510 HW1 and its packages, which are hosted on the [GitHub project page](https://github.com/sj23patel/se-fall20-hw1). These are mostly guidelines, not rules. Use your best judgment, and feel free to propose changes to this document in a pull request.
